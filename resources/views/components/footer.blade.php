<div class="mb-12"></div>
<footer class="mt-auto pt-3 pt-md-5 text-bg-color text-white">
  <div class="container">
    <div class="row">
      ...
      <div class="col-xl-4 col-lg-5 col-md-7 offset-xl-4 offset-lg-3 offset-md-1 mb-0 mb-md-3">
        ...
        <div class="d-flex flex-column flex-sm-row w-100 gap-2">
            <form action="{{ route('home.subscription') }}" method="POST" class="w-100">
              @csrf
  ...
  <div class="lower bg-darker-color py-2 mt-3">
    <div class="container">
